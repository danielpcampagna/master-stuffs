...
CREATE TABLE IF NOT EXISTS "advisements" (
    ...
    "main_advisor" boolean DEFAULT 0,
    "created_at" datetime NOT NULL,
    "updated_at" datetime NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "enrollment_holds" (
    ...
    "year" integer,
    "semester" integer,
    "number_of_semesters" integer DEFAULT 1,
    "created_at" datetime NOT NULL,
    "updated_at" datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS "enrollment_requests" (
    ...
    "semester" integer,
    "enrollment_id" integer,
    "last_student_change_at" datetime,
    "last_staff_change_at" datetime,
    "created_at" datetime(6) NOT NULL,
    "updated_at" datetime(6) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "professors" (
    ...
    "identity_issuing_body" varchar(255),
    "identity_expedition_date" varchar(255),
    ...
    "siape" varchar(255),
    "enrollment_number" varchar(255),
    "identity_issuing_place" varchar(255),
    "institution_id" integer,
    "email" varchar(255),
    "academic_title_date" date,
    "academic_title_country_id" integer,
    "academic_title_institution_id" integer,
    "academic_title_level_id" integer,
    "obs" text,
    "user_id" integer
);
...
CREATE TABLE IF NOT EXISTS "scholarships" (
    "id" integer PRIMARY KEY AUTOINCREMENT NOT NULL,
    "scholarship_number" varchar(255),
    "level_id" integer,
    "sponsor_id" integer,
